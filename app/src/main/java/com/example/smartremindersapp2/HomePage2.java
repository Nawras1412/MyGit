...
public class HomePage2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private static HomePage2 instance;
            ...
            public void onDataChange(DataSnapshot snapshot) {
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    if(ReminderType.equals("all")){
                        ...
                        if (Objects.equals(reminder.getMyType(), ReminderType))
                            reminders_locationList.add(reminder);
                    }
                }
...
//        calendar.set(Calendar.SECOND, 0);
    ...
    public static HomePage2 getInstance() {
        return instance;
    }

    private void updateLocation() {
        buildLocationRequest();
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(HomePage2.this);
...
//                Intent intent=new Intent(getApplicationContext(),location_reminder.class);
...
//                getApplicationContext().startActivity(intent);
    ...
    public void addReminder(String type) {
        ...
        dialog = new Dialog(HomePage2.this);
        ...
        discription = dialog.findViewById(R.id.description);
...
//        location = dialog.findViewById(R.id.location_txt2);
        ...
        if (Objects.equals(type,"Location")){
            Dexter.withActivity(HomePage2.this).withPermissions(Arrays.asList(Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_BACKGROUND_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION)).withListener(new MultiplePermissionsListener() {
                @Override
...
//
//                    });
                    bindService(new Intent(HomePage2.this, MyBackgroundService.class), mServiceConnection, Context.BIND_AUTO_CREATE);
                }
                @Override
        ...
        if (Objects.equals(type,"Date")) {
            select.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    DatePickerDialog dialog = new DatePickerDialog(HomePage2.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
...
//                            date=NotificationDate.getTime();
                            TimePickerDialog time = new TimePickerDialog(HomePage2.this, new TimePickerDialog.OnTimeSetListener() {
                                @Override
...
//                                        time_date.setVisibility(View.VISIBLE);
                                        ...
                                        Toast.makeText(HomePage2.this, "Invalid time", Toast.LENGTH_SHORT).show();
...
//                        calendar.set(Calendar.SECOND, 0);
                        ...
                        Toast.makeText(HomePage2.this, "Missing Location", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
                }
                else{
...
//                reminder.setKey(keyRef.getKey());
                ...
                Toast.makeText(HomePage2.this, "Inserted Successfully", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
